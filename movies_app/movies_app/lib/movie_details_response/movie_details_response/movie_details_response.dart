...
class MovieDetailsResponse {
  ...
  factory MovieDetailsResponse.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [MovieDetailsResponse].
  factory MovieDetailsResponse.fromJson(String data) {
    return MovieDetailsResponse.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [MovieDetailsResponse] to a JSON string.
